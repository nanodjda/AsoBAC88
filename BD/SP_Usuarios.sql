...
CREATE FUNCTION [SCH_ADMINISTRATIVO].[FN_BUSCAR_USUARIO]
(
	@UsuarioID		VARCHAR(15)
)
RETURNS INTEGER
...
CREATE PROCEDURE [SCH_ADMINISTRATIVO].[SP_BUSCAR_USUARIO]
(
	@UsuarioID		VARCHAR(15)
)
AS
	BEGIN
		SELECT [SCH_ADMINISTRATIVO].[FN_BUSCAR_USUARIO](@UsuarioID)
	END
GO